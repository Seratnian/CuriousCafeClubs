...
public class PhoneCalls extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_phone_calls, container, false);
            ...
            contacts.add(new Contact(getContext(), faces[rd.nextInt(faces.length - 1)], getString(R.string.name_01)));
            contacts.add(new Contact(getContext(), faces[rd.nextInt(faces.length - 1)], getString(R.string.name_02)));
            contacts.add(new Contact(getContext(), faces[rd.nextInt(faces.length - 1)], getString(R.string.name_03)));
            // TODO
